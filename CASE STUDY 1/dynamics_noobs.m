...
% Ya Hussain (a.s.)
%===================
% The presented code simulates the MAS control without obstacles
%===================
% Preparing MATLAB
...
global Snum iteration NOA NON 

%~~~~~~~~~~~~~~~~~~~
% General Parameters 

NON = 2;         % Number of Neurons
...
for k = 1:NOA
    ...
    hold on
    grid on 
    plot3(Pos(1,i),Pos(2,i),Pos(3,i),'kx','markersize',5,'linewidth',4)
    char = int2str(k);
