function centroids = Formation_Change(Xmat)
% In the name of GOD
% Ya Hussain (a.s.)
%========================
...
% ==========================
% Demonstration of centroids

%     figure(1)
%     voronoi(Gens(1,:),Gens(2,:),'k')
%     xlabel('y (m)')
%     ylabel('z (m)')
%     drawnow()
end

centroids = [Gens;zeros(1,NOA)];
end
